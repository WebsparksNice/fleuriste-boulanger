...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_produits_allergenes" AS ENUM('gluten', 'oeufs', 'lait', 'fruits-a-coque', 'arachides', 'soja', 'sesame', 'sulfites', 'lupin', 'moutarde', 'celeri', 'poisson', 'crustaces', 'mollusques');
  ...
  CREATE TYPE "public"."enum__produits_v_version_allergenes" AS ENUM('gluten', 'oeufs', 'lait', 'fruits-a-coque', 'arachides', 'soja', 'sesame', 'sulfites', 'lupin', 'moutarde', 'celeri', 'poisson', 'crustaces', 'mollusques');
  ...
  CREATE TABLE "produits_allergenes" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_produits_allergenes",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "_produits_v_version_allergenes" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum__produits_v_version_allergenes",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  ALTER TABLE "produits_allergenes" ADD CONSTRAINT "produits_allergenes_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."produits"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_produits_v_version_allergenes" ADD CONSTRAINT "_produits_v_version_allergenes_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_produits_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "produits_allergenes_order_idx" ON "produits_allergenes" USING btree ("order");
  CREATE INDEX "produits_allergenes_parent_idx" ON "produits_allergenes" USING btree ("parent_id");
  ...
  CREATE INDEX "_produits_v_version_allergenes_order_idx" ON "_produits_v_version_allergenes" USING btree ("order");
  CREATE INDEX "_produits_v_version_allergenes_parent_idx" ON "_produits_v_version_allergenes" USING btree ("parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_produits_allergenes";
  DROP TYPE "public"."enum_produits_disponibilite";
  DROP TYPE "public"."enum_produits_status";
  DROP TYPE "public"."enum__produits_v_version_allergenes";
